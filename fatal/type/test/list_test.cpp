...
TEST(insert_sorted, insert_sorted) {
  FATAL_EXPECT_SAME<
    type_list<int_val<0>>,
...
TEST(indexed_transform, indexed_transform) {
  FATAL_EXPECT_SAME<
    type_list<
